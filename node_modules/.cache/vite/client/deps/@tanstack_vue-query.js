...
// node_modules/.pnpm/@tanstack+vue-query@5.92.1_vue@3.5.26/node_modules/@tanstack/vue-query/build/modern/useQueryClient.js
import { hasInjectionContext, inject } from "vue-demi";

// node_modules/.pnpm/@tanstack+vue-query@5.92.1_vue@3.5.26/node_modules/@tanstack/vue-query/build/modern/utils.js
...
// node_modules/.pnpm/@tanstack+vue-query@5.92.1_vue@3.5.26/node_modules/@tanstack/vue-query/build/modern/vueQueryPlugin.js
import { isVue2 } from "vue-demi";

// node_modules/.pnpm/@tanstack+vue-query@5.92.1_vue@3.5.26/node_modules/@tanstack/vue-query/build/modern/queryClient.js
import { nextTick, ref } from "vue-demi";

// node_modules/.pnpm/@tanstack+vue-query@5.92.1_vue@3.5.26/node_modules/@tanstack/vue-query/build/modern/queryCache.js
...
// node_modules/.pnpm/@tanstack+vue-query@5.92.1_vue@3.5.26/node_modules/@tanstack/vue-query/build/modern/mutationCache.js
...
// node_modules/.pnpm/@tanstack+vue-query@5.92.1_vue@3.5.26/node_modules/@tanstack/vue-query/build/modern/devtools/devtools.js
...
// node_modules/.pnpm/@tanstack+vue-query@5.92.1_vue@3.5.26/node_modules/@tanstack/vue-query/build/modern/devtools/utils.js
...
// node_modules/.pnpm/@tanstack+vue-query@5.92.1_vue@3.5.26/node_modules/@tanstack/vue-query/build/modern/queryOptions.js
function queryOptions(options) {
  return options;
}

// node_modules/.pnpm/@tanstack+vue-query@5.92.1_vue@3.5.26/node_modules/@tanstack/vue-query/build/modern/infiniteQueryOptions.js
function infiniteQueryOptions(options) {
  return options;
}

// node_modules/.pnpm/@tanstack+vue-query@5.92.1_vue@3.5.26/node_modules/@tanstack/vue-query/build/modern/useBaseQuery.js
import {
  computed,
  getCurrentScope,
  onScopeDispose,
...
// node_modules/.pnpm/@tanstack+vue-query@5.92.1_vue@3.5.26/node_modules/@tanstack/vue-query/build/modern/useQuery.js
function useQuery(options, queryClient) {
  return useBaseQuery(QueryObserver, options, queryClient);
}

// node_modules/.pnpm/@tanstack+vue-query@5.92.1_vue@3.5.26/node_modules/@tanstack/vue-query/build/modern/useQueries.js
import {
  computed as computed2,
  getCurrentScope as getCurrentScope2,
  onScopeDispose as onScopeDispose2,
  readonly as readonly2,
  shallowReadonly as shallowReadonly2,
  shallowRef,
  unref as unref2,
  watch as watch2
} from "vue-demi";
function useQueries({
  ...
  const client = queryClient || useQueryClient();
  const defaultedQueries = computed2(() => {
    const resolvedQueries = typeof queries === "function" ? queries() : queries;
    const queriesRaw = unref2(resolvedQueries);
  ...
  watch2(defaultedQueries, (queriesValue) => {
    observer.setQueries(
      queriesValue,
      options
    );
  ...
  return options.shallow ? shallowReadonly2(state) : readonly2(state);
}

// node_modules/.pnpm/@tanstack+vue-query@5.92.1_vue@3.5.26/node_modules/@tanstack/vue-query/build/modern/useInfiniteQuery.js
...
// node_modules/.pnpm/@tanstack+vue-query@5.92.1_vue@3.5.26/node_modules/@tanstack/vue-query/build/modern/useMutation.js
import {
  computed as computed3,
  getCurrentScope as getCurrentScope3,
  onScopeDispose as onScopeDispose3,
  reactive as reactive2,
  readonly as readonly3,
  shallowReactive as shallowReactive2,
  shallowReadonly as shallowReadonly3,
  toRefs as toRefs2,
  watch as watch3
} from "vue-demi";
function useMutation(mutationOptions, queryClient) {
  ...
  const state = options.value.shallow ? shallowReactive2(observer.getCurrentResult()) : reactive2(observer.getCurrentResult());
  ...
  const readonlyState = options.value.shallow ? shallowReadonly3(state) : readonly3(state);
  const resultRefs = toRefs2(readonlyState);
  watch3(
    () => state.error,
    (error) => {
...
// node_modules/.pnpm/@tanstack+vue-query@5.92.1_vue@3.5.26/node_modules/@tanstack/vue-query/build/modern/useIsFetching.js
import { getCurrentScope as getCurrentScope4, onScopeDispose as onScopeDispose4, ref as ref2, watchEffect } from "vue-demi";
...
// node_modules/.pnpm/@tanstack+vue-query@5.92.1_vue@3.5.26/node_modules/@tanstack/vue-query/build/modern/useMutationState.js
import {
  computed as computed4,
  getCurrentScope as getCurrentScope5,
  onScopeDispose as onScopeDispose5,
  shallowReadonly as shallowReadonly4,
...
function useIsMutating(filters = {}, queryClient) {
  ...
  const length = computed4(() => mutationState.value.length);
  return length;
}
...
function useMutationState(options = {}, queryClient) {
  const resolvedOptions = computed4(() => {
  ...
  const state = shallowRef2(getResult(mutationCache, resolvedOptions.value));
  const unsubscribe = mutationCache.subscribe(() => {
    state.value = getResult(mutationCache, resolvedOptions.value);
  });
  watch4(resolvedOptions, () => {
    state.value = getResult(mutationCache, resolvedOptions.value);
  });
  onScopeDispose5(() => {
    unsubscribe();
  });
  return shallowReadonly4(state);
}
export {
  CancelledError,
  InfiniteQueryObserver,
